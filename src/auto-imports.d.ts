...
declare global {
  ...
  const flagshipProjects: typeof import('./components/apps/VSCode')['flagshipProjects']
  const forwardRef: typeof import('react')['forwardRef']
  const highlights: typeof import('./components/apps/VSCode')['highlights']
  const lazy: typeof import('react')['lazy']
  const memo: typeof import('react')['memo']
  const portfolioTheme: typeof import('./components/apps/VSCode')['portfolioTheme']
  ...
  const user: typeof import('./components/apps/VSCode')['user']
}
// for type re-export
declare global {
  // @ts-ignore
