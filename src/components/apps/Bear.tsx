    ...
    <ul>
      {items.map((item: BearMdData, index: number) => (
        <li
          ...
          className={`h-28 overflow-hidden flex flex-col cursor-default border-l-2 ${
            cur === index
        ...
        >
          <div className="h-8 mt-3 hstack min-w-0">
            <div className="-mt-1 w-10 vstack text-c-500">
              <span className={item.icon} />
            </div>
            <span
              className="relative min-w-0 flex-1 pr-9 font-bold truncate"
          ...
          <div
            className="flex-1 ml-10 overflow-hidden"
            p="b-3 r-3"
            text="xs c-500"
            border="b c-300"
            style={{
...
const Bear = () => {
  ...
  return (
    <div className="bear font-avenir flex h-full">
      ...
      <div className="w-80 overflow-auto" bg="gray-50 dark:gray-800" border="r c-300">
        <Middlebar
