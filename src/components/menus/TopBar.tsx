...
const TopBar = (props: TopBarProps) => {
  ...
  const { toggleFullScreen, setVolume, setBrightness, setKeyboardBrightness } = useStore((state) => ({
    toggleFullScreen: state.toggleFullScreen,
    setVolume: state.setVolume,
    setBrightness: state.setBrightness,
    setKeyboardBrightness: state.setKeyboardBrightness
  }));
  ...
  const setSiteKeyboardBrightness = (value: number): void => {
      ...
      <div className="hstack flex-row justify-end space-x-2">
        ...
        {state.showControlCenter && (
          <ControlCenterMenu
            ...
            setKeyboardBrightness={setSiteKeyboardBrightness}
