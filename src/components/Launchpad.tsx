    ...
    >
      <div className="size-full absolute bg-gray-900/20 backdrop-blur-2xl">
        ...
        {results.length > 0 ? (
          ...
          <div className="mx-auto mt-20 flex max-w-xl flex-col items-center px-6 text-center text-white">
            <div className="flex h-20 w-20 items-center justify-center rounded-3xl border border-white/15 bg-white/10 backdrop-blur-md">
              <span className="i-mdi:grid-off text-4xl" />
            </div>
            <div className="mt-6 text-sm uppercase tracking-[0.28em] text-white/60">
              Launchpad
            </div>
            <div className="mt-3 text-3xl font-semibold">No items here right now</div>
            <div className="mt-4 max-w-md text-base leading-7 text-white/70">
              Launchpad has been cleared out for a cleaner desktop. New shortcuts can
              be added back later if you want a more app-filled look again.
            </div>
          </div>
        )}
      </div>
